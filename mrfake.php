...
ob_start();
error_reporting(0);
define('API_KEY','1268561745:AAHcMwlwSEKTGDVFuPPG8Fco9IWCeC-RPos');
...
$Dev = array("667984976","267196482","237518639"); //ID ADMIN NUMBER 1 HE CHAT
@$usernamebot = "ASYADHM_BOT"; //UserName Bot
@$channel = "IIGII"; // UserName Channel don't @
@$token = API_KEY;
